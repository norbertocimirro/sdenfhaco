    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-100 flex justify-center">
      <div className="w-full max-w-md bg-white min-h-screen shadow-2xl relative flex flex-col">
        <div className="bg-white/90 backdrop-blur-md sticky top-0 z-50 px-5 py-4 flex justify-between items-center border-b border-slate-50">
          <div><h1 className="font-bold text-xl text-slate-800 tracking-tight" justify-center>Comissão de Prevenção<p></p>de Lesões de Pele</h1><p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest">Hospital de Aeronáutica de Canoas</p></div>
